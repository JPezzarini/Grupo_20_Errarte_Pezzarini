...
class Donante(Paciente):
    ...
    def __init__(self, nombre: str, dni: int, fecha_nac: datetime, sexo: str, tel: str, t_sangre: str, centro_salud: Centro_Salud, dt_fallecimiento: datetime, lista_organos: list[Organo]):
        """
        ...
        Atributos:
            ...
            - dt_fallecimiento (datetime): La fecha de fallecimiento del donante.
            - lista_organos (list[Organo]): La lista de órganos del donante.
    ...
    def __repr__(self) -> str:
        """
        Retorna un string con todos los atributos del donante.
        """
